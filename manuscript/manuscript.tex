...
\Abstract{
Blah, blah, blah\ldots{} We introduce \pkg{funres}, an \proglang{R} and
\proglang{Python} package for constructing and visualizing functional
residuals for various types of statistical models
}
